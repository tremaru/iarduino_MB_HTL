...
//   - если скорость известна, то строки с другими скоростями можно удалить.                           //
     ...
     if(!f){ Serial1.begin(  2400); while(!Serial1); delay(10); Serial.print('.'); f=sensor.begin(); } //   Инициируем работу с модулем на скорости   2400, без указания адреса (адрес будет найден автоматически).
     if(!f){ Serial1.begin(  4800); while(!Serial1); delay(10); Serial.print('.'); f=sensor.begin(); } //   Инициируем работу с модулем на скорости   4800, без указания адреса (адрес будет найден автоматически).
     if(!f){ Serial1.begin(  9600); while(!Serial1); delay(10); Serial.print('.'); f=sensor.begin(); } //   Инициируем работу с модулем на скорости   9600, без указания адреса (адрес будет найден автоматически).
     if(!f){ Serial1.begin( 19200); while(!Serial1); delay(10); Serial.print('.'); f=sensor.begin(); } //   Инициируем работу с модулем на скорости  19200, без указания адреса (адрес будет найден автоматически).
     if(!f){ Serial1.begin( 38400); while(!Serial1); delay(10); Serial.print('.'); f=sensor.begin(); } //   Инициируем работу с модулем на скорости  38400, без указания адреса (адрес будет найден автоматически).
     if(!f){ Serial1.begin( 57600); while(!Serial1); delay(10); Serial.print('.'); f=sensor.begin(); } //   Инициируем работу с модулем на скорости  57600, без указания адреса (адрес будет найден автоматически).
     if(!f){ Serial1.begin(115200); while(!Serial1); delay(10); Serial.print('.'); f=sensor.begin(); } //   Инициируем работу с модулем на скорости 115200, без указания адреса (адрес будет найден автоматически).
