//	Библиотека для работы с модулем датчиков влажности (H), температуры (T) и освещённости (L) по шине Modbus: https://iarduino.ru/shop/Sensory-Datchiki/climatic-type-1-Modbus-RS485.html
//  Версия: 1.0.3
